...
=== B-scan
The B-scan data consisted of $10,000$ A-scans of the sample, and $175$ backgrounds. The B-scan image was generated by stacking the A-scans together, and cropping to account for the mirror image artifact. The B-scan was then processed to improve the image quality by simply clipping the range of pixel values to around the max and minimum magnitudes of the region of interest illustrated in @fig:A-scan-analysis-bscan.
...
The generation of the A-scans is shown in @fig:A-scan and the time of each processing step during each generation is given in @tab:processing-times. Furthermore, the effect of deconvolution and background subtraction on the A-scan generation is shown in @fig:A-scan-processing-comparison.
...
#figure(
  ...
  caption: [A) Unprocessed B-scan B) unprocessed B-scan without deconvolution C) processed B-scan D) processed B-scan without deconvolution]
)<fig:B-scan>

A close up of the layers of tape is shown in @fig:B-scan-focused and 10 layers of tape are counted. From the analysis of @fig:A-scan-analysis-bscan, the thickness of the tape layers were on average $0.0552 "mm"$; and the distance between the layers was $0.0256 "mm"$.
...
#figure(
  image("figures/Ascan_Magnitude_Mscan1.png"),
  caption: [The average magnitude of the Mscan1 data.]
)<fig:A-scan-magnitude-mscan1>

#figure(
  image("figures/Ascan_Magnitude_Mscan40.png"),
  caption: [The average magnitude of the Mscan40 data.]
)<fig:A-scan-magnitude-mscan40>

#figure(
  image("figures/Displacement_Time_Mscan1_Peak1.png"),
  caption: [Displacement of the Mscan1 data. A) the first A-scan of the Bscan data B) A-scan at the center of the Bscan data C) A-scan at the center of the Mscan1 data D) A-scan at the center of the Mscan40 data]
)<fig:displacement-time-mscan1-peak1>

#figure(
  image("figures/Displacement_Time_Mscan1_Peak2.png"),
  caption: [Displacement of the Mscan1 data. A) the first A-scan of the Bscan data B) A-scan at the center of the Bscan data C) A-scan at the center of the Mscan1 data D) A-scan at the center of the Mscan40 data]
)<fig:displacement-time-mscan1-peak2>

#figure(
  image("figures/Displacement_Time_Mscan40_Peak1.png"),
  caption: [Displacement of the Mscan40 data. A) the first A-scan of the Bscan data B) A-scan at the center of the Bscan data C) A-scan at the center of the Mscan1 data D) A-scan at the center of the Mscan40 data]
)<fig:displacement-time-mscan40-peak1>

#figure(
  image("figures/Displacement_Time_Mscan40_Peak2.png"),
  caption: [Displacement of the Mscan40 data. A) the first A-scan of the Bscan data B) A-scan at the center of the Bscan data C) A-scan at the center of the Mscan1 data D) A-scan at the center of the Mscan40 data]
)<fig:displacement-time-mscan40-peak2>

#figure(
  image("figures/Displacement_Freq_Mscan1_Peak1.png"),
  caption: [Frequency of the Mscan1 data. A) the first A-scan of the Bscan data B) A-scan at the center of the Bscan data C) A-scan at the center of the Mscan1 data D) A-scan at the center of the Mscan40 data]
)<fig:displacement-freq-mscan1-peak1>

#figure(
  image("figures/Displacement_Freq_Mscan1_Peak2.png"),
  caption: [Frequency of the Mscan1 data. A) the first A-scan of the Bscan data B) A-scan at the center of the Bscan data C) A-scan at the center of the Mscan1 data D) A-scan at the center of the Mscan40 data]
)<fig:displacement-freq-mscan1-peak2>

#figure(
  image("figures/Displacement_Freq_Mscan40_Peak1.png"),
  caption: [Frequency of the Mscan40 data. A) the first A-scan of the Bscan data B) A-scan at the center of the Bscan data C) A-scan at the center of the Mscan1 data D) A-scan at the center of the Mscan40 data]
)<fig:displacement-freq-mscan40-peak1>

#figure(
  image("figures/Displacement_Freq_Mscan40_Peak2.png"),
  caption: [Frequency of the Mscan40 data. A) the first A-scan of the Bscan data B) A-scan at the center of the Bscan data C) A-scan at the center of the Mscan1 data D) A-scan at the center of the Mscan40 data]
)<fig:displacement-freq-mscan40-peak2>

= Discussion

Comparing the B-scan images with and without deconvolution in @fig:B-scan, it seems that the deconvolution process does not significantly improve the image quality.
