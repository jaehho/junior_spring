...
#figure(
  ...
  caption: [Average A-scan magnitude of M-scans, two prominent peaks are marked on each plot, which are further analyzed. A) M-scan 1 with peaks at $0.22 "mm"$ (pixel 61) and $0.34 "mm"$ (pixel 94) B) M-scan 40 with peaks at $0.22 "mm"$ (pixel 61) and $0.32 "mm"$ (pixel 89).]
)<fig:average-ascan>

#figure(
  image("figures/Displacement_Time_Mscan1.png"),
  caption: [Displacement over time for two prominent peaks in M-scan 1. The displacement axis was shifted to make the change in displacement clearer. A) first peak at $0.22 "mm"$ B) second peak at $0.34 "mm"$.]
)<fig:displacement-time-1>

#figure(
  image("figures/Displacement_Time_Mscan40.png"),
  caption: [Displacement over time for two prominent peaks in M-scan 40. The displacement axis was shifted to make the change in displacement clearer. A) first peak at $0.22 "mm"$ B) second peak at $0.32 "mm"$.]
)<fig:displacement-time-40>

#figure(
  image("figures/Displacement_Freq_Mscan1.png"),
  caption: [The frequency spectrum of the displacement over time for M-scan 1 at A) $0.22 "mm"$ with a peak at $4.01 "kHz"$ B) $0.34 "mm"$ with a peak at $4.01 "kHz"$.]
